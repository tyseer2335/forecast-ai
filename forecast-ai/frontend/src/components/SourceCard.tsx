...
const SourceCard: React.FC<SourceCardProps> = ({ source }) => {
    return (
        <div className="bg-sidebar-bg px-4 py-10 rounded-md flex space-x-4 h-full pr-20 w-[55%] max-w-[800px] relative overflow-y-auto">
            ...
            <div className="space-y-6 h-full flex flex-col justify-start w-[95%]">
                ...
                <img src={source.image} alt="source-img" className="w-[306px] h-[35%]" data-testid="source-image"/>
                <p className="text-source-text" data-testid="source-text">{source.text}</p>
            </div>
